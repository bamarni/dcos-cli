 ...
 */
def TEMPLATE_URLS = [:]
def DCOS_VERSIONS = ["1.8.9", "1.9.2", "master"]

withCredentials(
    [[$class: 'StringBinding',
      credentialsId: '1c2fb1a3-38a6-4289-a831-11da1b319412',
      variable: 'CF_TEMPLATE_URL_1_8_9'],
     [$class: 'StringBinding',
      credentialsId: '542aa287-9464-49cb-bdd3-9e4ca457dd87',
      variable: 'CF_TEMPLATE_URL_1_9_2'],
     [$class: 'StringBinding',
      credentialsId: 'fd1fe0ae-113d-4096-87b2-15aa9606bb4e',
      variable: 'CF_TEMPLATE_URL_MASTER']]) {

    TEMPLATE_URLS['1.8.9'] = "${env.CF_TEMPLATE_URL_1_8_9}"
    TEMPLATE_URLS['1.9.2'] = "${env.CF_TEMPLATE_URL_1_9_2}"
